...
export const NotFoundDos = () => { // Cambiado a NotFound para mantener consistencia
    return (
        <div className="not-found-wrapper">
            <div className="backgroundnf">
            ...
            <div className="containerNf">
                <div className="left-section">
                    <div className="inner-content">
                        ...
                        <p className="subheading"> {/* <-- Usamos <p> como en el original */}
                            Página no encontrada.
                            <br/> 
                            Presione el logo para regresar al inicio o seleccione otra opción del menu.
                        </p>
                    </div>
                </div>
                <div className="right-section">
                    {/* Pegamos el código completo del SVG aquí */}
                    <svg className="svgimg" xmlns="http://www.w3.org/2000/svg" viewBox="51.5 -15.288 385 505.565">
                        ...
                        <g className="top-bench">
                            ...
                            c0,1.534-1.243,2.778-2.777,2.778H188.194c-1.534,0-2.778-1.244-2.778-2.778v-8.333c0-1.534,1.244-2.777,2.777-2.777h209.723
