...
export const NotFound = () => {
    ...
    return (
      ...
      <div className="body backgroundnf animate__animated animate__fadeIn">
        <div className="ground" />
      </div>
      <div className="body containerNf">
        <div className="left-section">
          <div className="inner-content ">
            <h1 className="heading">404</h1>
            <p className="subheading">Página no encontrada.<br/> Presione el logo para regresar al inicio o seleccione otra opción del menu.</p>
          </div>
        </div>
